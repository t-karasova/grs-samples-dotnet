...
namespace grs_product.Tests
{
    ...
    public class ImportProductsInlineSourceTest
    {
        ...
        private const string CommandLineArguments = "/c " + "dotnet run -- ImportProductsInlineSource"; // The "/c" tells cmd to execute the command that follows, and then exit.
        ...
        public void TestOutputImportProductsInlineSource()
        {
            ...
            Assert.IsTrue(Regex.Match(consoleOutput, "(.*)The operation was started: Operation(.*)").Success);
